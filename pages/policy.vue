  ...
  <main class="max-width">
    <section class="rgpd">
      ...
      <div class="rgpd-content">
        ...
        <p>Un cookie est un petit fichier, stocké sur le disque dur d’un utilisateur par le site Web. Son but est de recueillir des données relatives à vos habitudes de navigation.</p>
        <p>Des cookies tiers sont utilisés afin de suivre votre activité quant à l'utilisation de ce site web.Vous pouvez choisir de désactiver les cookies entièrement dans votre navigateur Internet, mais cela peut nuire à votre expérience utilisateur.</p>
      </div>
    </section>
  </main>
</template>
